...
public class ManualDrive extends Command {
 ...
 //   MotorID motorID;
    ...
    public void execute() {
        ...
        XSpeed = MathUtil.applyDeadband(driveLeftAxis,0.15);
        YSpeed = MathUtil.applyDeadband(driveRightAxis, 0.15);
        rotationSpeed= MathUtil.applyDeadband(driveRotation, 0.15);
